...
(0, _flatpickrDefault.default)("#datetime-picker", {
    ...
    onClose: (selectedDates)=>{
        ...
        if (selectedDate < currentDate) {
            (0, _notiflixDefault.default).Notify.info("Please choose a date in the future");
...
function convertMs(ms) {
    ...
    if (remainingDays === 0 && remainingHours === 0 && remainingMinutes === 0 && remainingSeconds === 0) clearInterval(countdownInterval);
